...
@AllArgsConstructor
@NoArgsConstructor
public class HooverDto extends ModelDto {
    ...
    public HooverDto(Long id, ProductName productName, String country, String company, Boolean isOrderOnline, Boolean isPossibleInstallments, String name, String serialNumber, String color, String size, BigDecimal price, Boolean isAvailable, String dustCollectorVolume, String modeQuantity) {
